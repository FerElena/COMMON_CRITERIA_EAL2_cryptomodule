...
void print_test_Result(uint8_t result[],unsigned char test_name[]){  // funtions for printing test fails in case of test failure
    for(int i = 0 ; i < 50 ; i++){
        if(result[i]){
            printf("\x1B[31m" "test number %d in the testing of funtion %s have failed" "\x1B[0m" "\n",i,test_name);
            result[i]--;
        }
    }
}
...
void FS_testing(){ 
    printf("\x1B[34m" "                           FILESYSTEM_UNITARYTESTING_BEGIN" "\x1B[0m" "\n");
    ...
    printf("\x1B[34m" "\nAPI_FS_initiate_file_system TESTING " "\x1B[0m" "\n");
    //testing MODE_INIT
    ...
    API_FS_setup_cipher(CIPHER_MODE,key,iv);
    ...
    if(correct_test){
        printf("\x1B[32m" "tests of API_FS_initiate_file_system passed correctly" "\x1B[0m" "\n");
    }
    else{
    ...
    printf("\x1B[34m" "\nAPI_FS_exists_file TESTING " "\x1B[0m" "\n");
    ...
    if(correct_test){
        printf("\x1B[32m" "tests of API_FS_exists_file passed correctly" "\x1B[0m" "\n");
    }
    else{
    ...
    printf("\x1B[34m" "\nAPI_FS_create_file_data TESTING " "\x1B[0m" "\n");
    ...
    if(correct_test){
        printf("\x1B[32m" "tests of API_FS_create_file_data passed correctly" "\x1B[0m" "\n");
    }
    else{
    ...
    printf("\x1B[34m" "\nAPI_FS_delete_file TESTING " "\x1B[0m" "\n");
    ...
    if(correct_test){
        printf("\x1B[32m" "tests of API_FS_delete_file passed correctly" "\x1B[0m" "\n");
    }
    else{
    ...
    printf("\x1B[34m" "\nAPI_FS_read_file_data TESTING " "\x1B[0m" "\n");
    ...
    if(correct_test){
        printf("\x1B[32m" "tests of API_FS_read_file_data passed correctly" "\x1B[0m" "\n");
    }
    else{
    ...
    printf("\x1B[34m" "\nAPI_FS_rename_file TESTING " "\x1B[0m" "\n");
    ...
    if(correct_test){
        printf("\x1B[32m" "tests of API_FS_rename_file passed correctly" "\x1B[0m" "\n");
    }
    else{
    ...
    printf("\x1B[34m" "\nAPI_FS_update_file_data TESTING " "\x1B[0m" "\n");
    ...
    if(correct_test){
        printf("\x1B[32m" "tests of API_FS_update_file_data passed correctly" "\x1B[0m" "\n");
    }
    else{
    ...
    printf("\x1B[34m" "\nAPI_FS_write_buffer_to_file TESTING " "\x1B[0m" "\n");
    ...
    if(correct_test){
        printf("\x1B[32m" "tests of API_FS_write_buffer_to_file passed correctly" "\x1B[0m" "\n");
    }
    else{
    ...
    printf("\x1B[34m" "\n API_FS_read_buffer_from_file TESTING " "\x1B[0m" "\n");
    ...
    if(correct_test){
        printf("\x1B[32m" "tests of API_FS_read_buffer_from_file passed correctly" "\x1B[0m" "\n");
    }
    else{
    ...
    print_files();
    printf("\x1B[34m" "\n API_FS_zeroize_file_system TESTING " "\x1B[0m" "\n");
    ...
    unsigned char *zeroize_text_buffer;
    int zeroize_length;

    int aux3 = API_FS_read_file_data(filename4,strlen(filename4),&zeroize_text_buffer,&zeroize_length);
    if(CIPHER_MODE){
        AES_OFB_EncryptDecrypt(zeroize_text_buffer,zeroize_length,key,AES_KEY_SIZE_256,iv,zeroize_text_buffer);
    }

    for(int i = 0 ; i < zeroize_length ; i++){
        if(zeroize_text_buffer[i] != 0x55){
            failed_test[1]++;
            correct_test = 0;
        }
    }

    API_FS_read_file_data(filename25,strlen(filename25),&zeroize_text_buffer,&zeroize_length);
    if(CIPHER_MODE){
        AES_OFB_EncryptDecrypt(zeroize_text_buffer,zeroize_length,key,AES_KEY_SIZE_256,iv,zeroize_text_buffer);
    }
    ...
    if(correct_test){
        printf("\x1B[32m" "tests of API_FS_zeroize_file_system passed correctly" "\x1B[0m" "\n");
    }
    else{
    ...
    if(finalvalue == 1){
        ...
        printf("\x1B[31m" "\n\n                FILESYSTEM TESTS FAILED, CHECK WHICH TESTS FAILED AND CORRECT IT" "\x1B[0m" "\n");
    }
